...
def result():
    ...
    return render_template('result.html', nodes=nodes, default_start_node=start_node, default_end_node=end_node,img_path=img_path)
...
def update_path():
    ...
    return jsonify({'shortest_path_info': shortest_path_info})
